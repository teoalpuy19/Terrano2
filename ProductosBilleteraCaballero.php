			...
			<div class="content-xs">
				...
				<div id="filters-container" class="cbp-l-filters-text content-xs" >
				 ...
				 <div id="filters-container" class="cbp-l-filters-text content-xs" >
					...
					<div  name="sort" class="sort_rang cbp-filter-item"><a href="ProductosBilleteraCaballero.php">Caballero</a></div>|
					<div  name="sort" class="sort_rang cbp-filter-item"><a href="ProductosBilleterasDama.php">Dama</a></div>|
				</div><!--/end Filters Container-->
					</form>
		...
		<div id="ajax_result" >
				...
				<?php
						include "conexion.php";
                                              $sql = "SELECT * FROM Producto where `Category`='B1'";
					...
					<?php foreach ($all_row as $key => $Productos) { ?>
						...
						<div class="web-design cbp-item ">
									...
									<div class="cbp-title-dark">
										...
										<div class="cbp-l-grid-agency-desc"><?php  echo "COD: ".$Productos['ImageShow']?></div>
									</div>
